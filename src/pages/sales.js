...
export default function Sales(){
    ...
    function allocate(e){
        ...
        axios.post("/api/allocateTime", {data: e.target.value})
        .then((res)=>{
    ...
    return(
        <>
            ...
            </div>
            {
                data.map((item)=>{
                    return(
                        <div className="flex flex-col gap-2 m-5 my-10">
                            <div>{item.Name}</div>
                            <div>
                                <div>
                                    Mon
                                ...
                                <form>
                                    {   
                                        item.Mon&&
                                        item.Mon.split(" ").filter((item)=>{return filterTime(item)}).map((time, idx)=>{
                                            return(
